...
/*
 * fnuecke: adjusted some names for use in Eris but not overlap in case boost
 *          is already present. Eris only supports little and big endian, too,
 *          so this could be slightly simplified. This file is only meant to be
 *          included by eris.c.
 */

#ifndef ERIS_ENDIAN_H
#define ERIS_ENDIAN_H
...
#  define ERIS_LITTLE_ENDIAN
# elif (__BYTE_ORDER == __BIG_ENDIAN)
#  define ERIS_BIG_ENDIAN
# else
